...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final KandroidLibraryAccessors laccForKandroidLibraryAccessors = new KandroidLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>kandroid</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KandroidLibraryAccessors getKandroid() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKandroidLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class KandroidLibraryAccessors extends SubDependencyFactory {
        private final KandroidSegmentedLibraryAccessors laccForKandroidSegmentedLibraryAccessors = new KandroidSegmentedLibraryAccessors(owner);

        public KandroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>kandroid.segmented</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KandroidSegmentedLibraryAccessors getSegmented() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKandroidSegmentedLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KandroidSegmentedLibraryAccessors extends SubDependencyFactory {

        public KandroidSegmentedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>control</b> with <b>com.github.Kaopiz:kandroid-segmented-control</b> coordinates and
         * with version reference <b>kandroidSegmentedControl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getControl() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kandroid.segmented.control");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kandroidSegmentedControl</b> with value <b>1.0.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKandroidSegmentedControl() { return getVersion("kandroidSegmentedControl"); }
